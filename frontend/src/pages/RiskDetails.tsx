        ...
        <div className={"ScreenLimit"}>
            ...
            <div>
                <form>
                    <div>
                        <h4>Risk factor</h4>
                        <input placeholder={"Risk Factor Name"} name={"riskName"} value={currentRisk.riskName} onInput={editRisk}></input>
                        <input placeholder={"Risk Factor description"} name={"riskDescription"} value={currentRisk.riskDescription} onChange={editRisk}></input>
                    </div>
                    <div>
            ...
            <div>
                {currentRisk ? <RiskSummaryCard {...currentRisk}/> : null}
            </div>
        </div>
